...
- (void)viewConfig
{
    CGFloat functionButtonX = _showArrowButton ? (SCREEN_WIDTH - ARROW_BUTTON_WIDTH) : SCREEN_WIDTH - 40;
    if (_showArrowButton)
    {
    ...
    _navgationTabBar = [[UIScrollView alloc] initWithFrame:CGRectMake(20, DOT_COORDINATE, functionButtonX, NAV_TAB_BAR_HEIGHT)];
